  ...
  return (
    <footer className="border-t border-ui-border-base w-full">
      <div className="content-container flex flex-col w-full">
        <div className="flex flex-col gap-y-6 md:flex-row items-start justify-between py-24">
          <div>
            <LocalizedClientLink
              href="/"
          ...
          <div className="text-small-regular gap-10 md:gap-x-16 grid grid-cols-2 sm:grid-cols-3 mt-8">
